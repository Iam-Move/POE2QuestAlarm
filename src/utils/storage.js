...
export function saveState(state) {
  try {
    const data = {
      ...
      hiddenActs: state.hiddenActs || [],
      permanentlyHiddenActs: state.permanentlyHiddenActs || [],
      actOverrides: state.actOverrides || {},
...
export function loadState() {
  try {
    ...
    return {
      ...
      hiddenActs: data.hiddenActs || [],
      permanentlyHiddenActs: data.permanentlyHiddenActs || [],
      actOverrides: data.actOverrides || {},
      actOrder: data.actOrder || [],
